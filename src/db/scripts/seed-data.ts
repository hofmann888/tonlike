...
export const actions = [
  ...
  { name: 'task_create', title: 'Create a task', active: true }, // id: 11,
  { name: 'task_done', title: 'Complete a task', active: true }, // id: 12,
  { name: 'quest_done', title: 'Complete a quest', active: true }, // id: 13,
  { name: 'kyc', title: 'Sign up + KYC', active: true }, // id: 14,
];
